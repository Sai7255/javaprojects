...
.style26 {font-size: 14px; color: #FF0000; font-weight: bold; }
-->
</style>
</head>
<body>
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <table width="500" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
            <tr>
              <td width="108" height="30" bgcolor="#FFFF00"><div align="center" class="style21 style24"><strong> ID </strong></div></td>
              <td width="183" bgcolor="#FFFF00"><div align="center" class="style26">End User  Name </div></td>
              <td width="171" bgcolor="#FFFF00"><div align="center" class="style26"> Status </div></td>
              <%	  
