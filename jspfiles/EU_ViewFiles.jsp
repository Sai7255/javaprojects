...
try 
	{		
				...
				%>
              <tr>
                <td width="72" height="30" bgcolor="#FFFF00"><div align="center" class="style21 style24"><strong> ID </strong></div></td>
                <td width="131" bgcolor="#FFFF00"><div align="center" class="style25">File Name </div></td>
                <td width="141" bgcolor="#FFFF00"><div align="center" class="style25">Data Owner </div></td>
                <td width="177" bgcolor="#FFFF00"><div align="center" class="style25">Date &amp; Time </div></td>
              </tr>
              <%
