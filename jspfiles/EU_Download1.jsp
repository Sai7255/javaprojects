...
.style24 {font-size: 20px; font-weight: bold; color: #FF0000; }
					...
					if(rs12.next()==true)
					{
						...
						else
						{
							...
							{  
								...
								<tr>
								<td width="212" height="40" bgcolor="#FFFF00"><span class="style22"> File Name :-</span></td>
								...
								<tr>
								<td height="40" bgcolor="#FFFF00"><span class="style22">Trapdoor :-</span></td>
								<td><input name="t122" type="text" value="<%=shared_trapdoor%>" size="40" /></td>
								</tr>
								<tr>
								<td height="40" bgcolor="#FFFF00"><span class="style22">Decrypt Key :-</span></td>
								<td><input name="t134" type="text" value="<%=dk%>" size="40" /></td>
								</tr>
								<tr>
								<td height="40" bgcolor="#FFFF00"><span class="style22">Secret Key :-</span></td>
			...
			if(rs1.next()==true)
			{
				...
				else
				{
					...
					{  
						...
						<table width="509" style="border-collapse:collapse" cellpadding="0" cellspacing="0" height="241" border="0" align="center">
						<tr>
						<td width="212" height="40"><span class="style24"> File Name :-</span></td>
						<td width="342"><span class="style18">
						<label>
						<input required="required" name="t14" type="text" value="<%=file%>" size="40" />
						</label>
						...
						<tr>
						<td height="40"><span class="style24">Trapdoor :-</span></td>
						<td><input name="t122" type="text" value="<%=trapdoor%>" size="40" /></td>
						</tr>
						<tr>
						<td height="40"><span class="style24">Decrypt Key :-</span></td>
						<td><input name="t134" type="text" value="<%=dk%>" size="40" /></td>
						</tr>
						<tr>
						...
						<tr>
						<td height="40"><div align="right"><span class="style18"><span class="style25"></span></span></div></td>
						<td><span class="style18">
						<label>
						<input type="submit" name="Submit222" value="Decrypt and Download" />
						</label>
						</span> </td>
						</tr>
						</table>
