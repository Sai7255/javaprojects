          ...
          <h2>Search File </h2>
            <form id="form1" method="post" action="EU_Search1.jsp">
              ...
              <table width="487" border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
                <tr>
                  <th width="236" height="40" scope="row"><div align="left"><span class="style15"><span class="odd  style16"><marquee behavior="alternate">Enter The Keyword To Search :</marquee> </span></span></div></th>
