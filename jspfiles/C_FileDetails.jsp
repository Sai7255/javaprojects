...
.style35 {font-size: 12px; color: #FF0000; }
-->
</style>
</head>
<body>
...
try 
	{
          ...
          <table width="549" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0" align="center">
            <tr>
              <td width="142" height="36" bgcolor="#FFFF00"><div align="center" class="style29 style32 style34">
            ...
            <tr>
              <td height="36" bgcolor="#FFFF00"><div align="center" class="style35">
                  <div align="left"><strong>File Name : </strong></div>
              </div></td>
              <td><input readonly="readonly"  name="textfield2" type="text" size="49" value="<%=s2%>" />              </td>
            </tr>
            <tr>
              <td height="186" bgcolor="#FFFF00"><div align="center" class="style35">
